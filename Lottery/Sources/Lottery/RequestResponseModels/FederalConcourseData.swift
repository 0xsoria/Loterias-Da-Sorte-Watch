...
struct FederalConcourseData: Codable {
    ...
    func federalWorkerDataToLotteryWorker() -> LotteryModel {
        return LotteryModel(lotteryGame: .federal,
...
public struct FederalGamePrize: Codable, Equatable {
    public let nome: String
    public let bilhete: String
    public let valor_total: DoubleIntLottery
    public let faixa: Int
}
